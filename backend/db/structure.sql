...
--
-- Name: anuncioventa_metododepago; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.anuncioventa_metododepago (
    id bigint NOT NULL,
    anuncioventa_id integer NOT NULL,
...
--
-- Name: anuncioventa_metododepago_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.anuncioventa_metododepago_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: anuncioventa_metododepago_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.anuncioventa_metododepago_id_seq OWNED BY public.anuncioventa_metododepago.id;
...
--
-- Name: divipola_msip; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: metododepago; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.metododepago (
    id bigint NOT NULL,
    nombre character varying(500) NOT NULL COLLATE public.es_co_utf_8,
...
--
-- Name: metododepago_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.metododepago_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: metododepago_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
COMMENT ON TABLE public.msip_grupoper IS 'Creado por msip en msipdes_des';
...
--
-- Name: pesoporton; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.pesoporton (
    id bigint NOT NULL,
    valor numeric,
...
--
-- Name: pesoporton_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.pesoporton_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: pesoporton_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.pesoporton_id_seq OWNED BY public.pesoporton.id;
...
--
-- Name: anuncioventa_metododepago id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.anuncioventa_metododepago ALTER COLUMN id SET DEFAULT nextval('public.anuncioventa_metododepago_id_seq'::regclass);


--
-- Name: metododepago id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: pesoporton id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pesoporton ALTER COLUMN id SET DEFAULT nextval('public.pesoporton_id_seq'::regclass);
...
--
-- Name: anuncioventa_metododepago anuncioventa_metododepago_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.anuncioventa_metododepago
    ADD CONSTRAINT anuncioventa_metododepago_pkey PRIMARY KEY (id);
...
--
-- Name: msip_clase clase_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: metododepago metododepago_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_municipio municipio_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pesoporton pesoporton_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pesoporton
    ADD CONSTRAINT pesoporton_pkey PRIMARY KEY (id);
...
--
-- Name: anuncioventa_metododepago fk_rails_231742ca71; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.anuncioventa_metododepago
    ADD CONSTRAINT fk_rails_231742ca71 FOREIGN KEY (anuncioventa_id) REFERENCES public.anuncioventa(id);
...
--
-- Name: anuncioventa_metododepago fk_rails_655337a8a5; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.anuncioventa_metododepago
    ADD CONSTRAINT fk_rails_655337a8a5 FOREIGN KEY (metododepago_id) REFERENCES public.metododepago(id);
...
--
-- Name: anuncioventa fk_rails_a88d1dd357; Type: FK CONSTRAINT; Schema: public; Owner: -
--
